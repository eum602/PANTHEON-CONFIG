...
../ADMIN_METHODS/admin_method_addPeer.sh $ENODE_2 $RPC_URL_1
../ADMIN_METHODS/admin_method_addPeer.sh $ENODE_2 $RPC_URL_3
../ADMIN_METHODS/admin_method_addPeer.sh $ENODE_2 $RPC_URL_4


../ADMIN_METHODS/admin_method_addPeer.sh $ENODE_3 $RPC_URL_1
../ADMIN_METHODS/admin_method_addPeer.sh $ENODE_3 $RPC_URL_2
../ADMIN_METHODS/admin_method_addPeer.sh $ENODE_3 $RPC_URL_3


../ADMIN_METHODS/admin_method_addPeer.sh $ENODE_4 $RPC_URL_1
../ADMIN_METHODS/admin_method_addPeer.sh $ENODE_4 $RPC_URL_2
../ADMIN_METHODS/admin_method_addPeer.sh $ENODE_4 $RPC_URL_3